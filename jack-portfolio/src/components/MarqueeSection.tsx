      ...
      >
        {tripled.map((src, i) => (
          <img
            ...
            src={src}
            alt=""
            className="h-[190px] w-[300px] flex-shrink-0 rounded-2xl object-cover sm:h-[230px] sm:w-[360px] md:h-[270px] md:w-[420px]"
            loading="lazy"
          />
        ))}
      </div>
  ...
  return (
    <section ref={sectionRef} className="bg-[#0C0C0C] pb-10 pt-24 sm:pt-32 md:pt-40">
      <div className="flex flex-col gap-3 overflow-hidden">
        {renderRow(row1Images, 'right')}
        {renderRow(row2Images, 'left')}
      </div>
    </section>
  );
}
