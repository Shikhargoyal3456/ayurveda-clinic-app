...
def superapp_dashboard_page(request: Request):
    ...
    return templates.TemplateResponse(request, "dashboard/superapp_dashboard.html", {"request": request, **get_dashboard_payload()})
...
def smart_subscriptions_page(request: Request):
    ...
    return templates.TemplateResponse(request, "subscription/smart_subscriptions.html", {"request": request, **payload})
